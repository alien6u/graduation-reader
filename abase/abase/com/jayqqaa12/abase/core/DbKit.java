...
public class DbKit {
     ...
     * key: dbName
     */
    private static HashMap<String, DbKit> daoMap = new HashMap<String, DbKit>();
    ...
    private DbKit(DaoConfig config) {
        if (config == null) {
    ...
    private synchronized static DbKit getInstance(DaoConfig daoConfig) {
        DbKit dao = daoMap.get(daoConfig.getDbName());
        if (dao == null) {
            dao = new DbKit(daoConfig);
    ...
    public static DbKit create(Context context) {
        DaoConfig config = new DaoConfig(context);
        return getInstance(config);
    }

    public static DbKit create(Context context, String dbName) {
        DaoConfig config = new DaoConfig(context);
        config.setDbName(dbName);
        return getInstance(config);
    }

    public static DbKit create(Context context, String dbDir, String dbName) {
        DaoConfig config = new DaoConfig(context);
    ...
    public static DbKit create(Context context, String dbName, int dbVersion, DbUpgradeListener dbUpgradeListener) {
        DaoConfig config = new DaoConfig(context);
        config.setDbName(dbName);
    ...
    public static DbKit create(Context context, String dbDir, String dbName, int dbVersion, DbUpgradeListener dbUpgradeListener) {
        DaoConfig config = new DaoConfig(context);
        config.setDbDir(dbDir);
        config.setDbName(dbName);
        config.setDbVersion(dbVersion);
    ...
    public static DbKit create(DaoConfig daoConfig) {
        return getInstance(daoConfig);
    }

    public DbKit configDebug(boolean debug) {
        this.debug = debug;
        return this;
    }

    public DbKit configAllowTransaction(boolean allowTransaction) {
    ...
    public interface DbUpgradeListener {
        public void onUpgrade(DbKit db, int oldVersion, int newVersion);
    }
